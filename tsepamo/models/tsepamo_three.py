...
class TsepamoThree(RecordIDModelMixin, models.Model):
    ...
    site = models.CharField(
        ...
        choices=(
            ...
            ("7", "Mahalapye"),
            ("8", "Selebi-Phikwe"),
            ("9", "Bamalete Lutheran Hospital"),
            ("10", "Palapye Primary Hospital"),
            ("11", "Deborah Retief Hospaital"),
            ("12", "Kanye SDA Hospital"),
            ("13", "Athlone Hospital"),
            ("14", "Bobonong Primary Hospital"),
            ("15", "Gumare Primary Hospital"),
            ("16", "Goodhope Primary Hospital"),
            ("17", "Tutume Primary Hospital"),
    ...
    placental_diagnosis = models.CharField(
        ...
        choices=(
            ...
            (
                "2",
                "2 XXX (this question is requires further input from Drucilla)",
            ),
        ),
        help_text="",
    )
    ...
    anymedhist = models.CharField(
        ...
        choices=(
            ...
            ("15", "PIH/Gestational Hypertension"),
            ...
            ("16", "Migraine/severe headache"),
            ("17", "DVT (Deep Vein Thrombosis)"),
            ("19", "Genital warts/warts"),
            ("20", "Fibroids/fibroid uterus"),
            ("21", "Backache/Waist ache/ chronic back pain"),
            ("0", "NONE"),
            ("99", "UNKNOWN"),
        ),
    ...
    tbhist_currenttreat = models.CharField(
        ...
        choices=(
            ("1", "Yes"),
            ("0", "No (TB treated BEFORE this pregnancy or not documented)"),
        ),
        help_text="",
    )
    ...
    highbpmed = models.CharField(
        ...
        choices=(
            ...
            ("9", "Propranolol"),
            ("10", "Carvedilol"),
            ("11", "Unspecified antihypertensive medication"),
            ("8", "Other"),
            ("0", "NONE"),
            ("99", "UNKNOWN"),
        ),
    ...
    nohivform_reason = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "Participant not approached because of  weekend/holiday"),
            (
                "2",
    ...
    hivform_summary = models.TextField(
        ...
        blank=True,
        null=True,
        help_text="we will use this to go back and check for errors when comparing to other REDCap questions",
    )
    ...
    timingtest = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Known to be HIV+ prior to current pregnancy"),
    ...
    counseledonfeeding = models.CharField(
        ...
        choices=(
            ("1", "Yes"),
            ("2", "No (documented that no counseling provided)"),
    ...
    plannedfeeding = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "Breastfeeding (BF or EBF)"),
            ("2", "Formula feeding (FF or EFF)"),
            ("3", "Undecided"),
            ("4", "Unknown (not recorded)"),
        ),
        blank=True,
        null=True,
        help_text="",
    ...
    initialreg = models.CharField(
        ...
        choices=(
            ("1", "AZT only"),
            ("2", "Atripla (or TDF/FTC/EFV or TRU/EFV or Atroiza)"),
            ("21", "TDF/FTC/DTG (or TRU/DTG)(or TRU/Dolutegravir)"),
            ("30", "TDF/3TC/DTG (or TLD or DLT or TDF/3TC/Dolutegravir)"),
            (
                "32",
                "TAF-ED (or TAF/FTC/DTG or Tenofovir Alafenamide/emtricitabine/dolutegravir)",
            ),
            ("29", "EFV/D4T/3TC"),
            ("3", "NVP/CBV (or NVP/AZT/3TC)"),
            ("4", "ALU/CBV (or ALU/AZT/3TC or LPV/rit/AZT/3TC)"),
            ("5", "NVP/D4T/3TC"),
            ("6", "ALU/D4T/3TC (or LPV/rit/D4T/3TC)"),
            ("7", "NVP/TRU (or NVP/TDF/FTC)"),
            ("8", "ALU/TRU (or ALU/TDF/FTC or LPV/rit/TDF/FTC)"),
            ("9", "EFV/CBV (or EFV/AZT/3TC)"),
            ("10", "EFV/TRU"),
            ("26", "ABC/3TC/DTG (Abacavir/3TC/Dolutegravir)"),
            ("11", "ABC/3TC/NVP"),
            ("12", "ABC/3TC/LPV/rit"),
            ("13", "ABC/3TC/EFV"),
            ("25", "ABC/D4T/LPV-r (or ABC/3TC/ALU)"),
            ("14", "TRU/RAL"),
            ("15", "Tenolam/NVP"),
            ("16", "Tenolam/LPV/rit"),
            ("17", "Tenolam/EFV (TDF/3TC/EFV or TLE or AVONZA)"),
    ...
    replot_reason = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Based on ultrasound"),
            ("2", "Based on measurements (eg, fundal height)"),
            ("4", "miscalculation"),
            ("3", "Other"),
            ("99", "Unknown"),
        ),
    ...
    reason_rbd = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Primigravid and age >30"),
            ("28", "Primigravid (age not >30)"),
            ("2", "Age < 18"),
            ("3", "Age >35"),
            (
                "4",
            ...
            (
                "9",
                "Congenital abnormality of infant noted during antenatal care",
            ),
            ...
            ("18", "Bad Obstetric History (BOH)"),
            ("19", "IUFD (fetal demise)"),
            ("20", "CPD/Big baby (cephalo-pelvic disproportion)"),
            ("21", "post-dates"),
            (
                "22",
                "presentation of the baby (e.g breech, footling, transverse)",
            ),
            ("25", "failed induction"),
            ("26", "multiparous/grand multip"),
            ("24", "Failure to progress/stalled labor/prolonged labor"),
            ("27", "Placenta previa"),
            ("29", "twin (or triplet) pregnancy"),
            ("30", "for Labor Pains/ for Delivery"),
            ("13", "UNKNOWN"),
            ("14", "OTHER"),
        ),
    ...
    anymatdiag = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Herpes (HSV)/Genital Ulcers/Genital Sores"),
            ("2", "Varicella (chicken pox or zoster)"),
            ("3", "Rubella"),
            ("4", "Toxoplasmosis"),
            ("5", "Syphilis (VDRL +, VDRL-reactive)"),
            (
                "6",
            ...
            ("12", "Pre-Ecclampsia or Ecclampsia"),
            ("9", "Diabetes"),
            ...
            ("16", "asthma"),
            ("17", "breast lump"),
            ("18", "Candida/Candidiasis"),
            ("19", "Cold/Common cold"),
            ("20", "Cough"),
            ("21", "diarrhoea, gastroenteritis"),
            ("22", "epigastric pain"),
            ("23", "fever"),
            ("24", "ear infection"),
            ("25", "eye infection"),
            ...
            ("29", "heartburn"),
            ("30", "hyperemesis"),
            ("31", "PID (pelvic inflammatory disease)"),
            ("32", "Rash"),
            (
                "33",
                "Respiratory tract infection/URTI (upper resp tract infection)",
            ),
            ("34", "sore throat/tonsillitis"),
            ("35", "psychiatric/mental disorders"),
            ("36", "Assault/Trauma"),
            ("37", "Epilepsy/Seizures"),
            ("38", "Scorpion stings/bites"),
            ("39", "Parasites/Intestinal worms"),
            ("40", "Fungal Infection"),
            ("41", "Gastritis/Peptic Ulcer/Abdominal Ulcer"),
            ("42", "Cancer"),
            ("43", "DVT"),
            ("44", "Bronchitis"),
            ("45", "Pneumonia"),
            ("46", "Epistaxis (bleeding from the nose)"),
            ("47", "Hypotension"),
            ("48", "Cyst"),
            ("49", "Abdominal Pain"),
            ("50", "Backache/Waist ache"),
            ("51", "altered comfort/pain"),
            ("8", "Other"),
            ("0", "None"),
            ("99", "Unknown"),
        ),
    ...
    malaria_med = models.CharField(
        ...
        choices=(
            ...
            ("3", "Coartem (arthemether lumefantrine)"),
            ("4", "Quinidine"),
            ("5", "Other"),
        ),
        help_text="Choose All that Apply",
    ...
    prep_hivneg_formavail = models.CharField(
        verbose_name="Is the PrEP/PEP Data Abstraction form available?",
        max_length=1,
        choices=(("1", "Yes"), ("0", "No")),
        help_text="",
    )

    prep_hivneg_notavail = models.CharField(
        verbose_name="Why was the PrEP/PEP data abstraction form not available?",
        max_length=1,
        choices=(
            ("1", "Participant not approached because of  weekend/holiday"),
            (
    ...
    arv_hivneg_reg = models.CharField(
        ...
        choices=(
            ...
            ("4", "cabotegravir injectible (CAB-LA, CAB)"),
            ("6", "Unspecified"),
            ("5", "other"),
        ),
        help_text="",
    ...
    arv_hivneg_source = models.CharField(
        verbose_name=" Which antiretrovirals (ARVs) did the patient receive during pregnancy? Source of information used? (choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    prep_prior_tdfsource = models.CharField(
        verbose_name="Was TDF/FTC started prior to conception? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    prep_prior_tafsource = models.CharField(
        verbose_name="Was TAF/FTC started prior to conception? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    prep_prior_tldsource = models.CharField(
        verbose_name="WasTLD started prior to conception? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    prep_prior_cabsource = models.CharField(
        verbose_name="Was Cabotegravir  started prior to conception? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    prep_prior_unspsource = models.CharField(
        verbose_name="Was unspecified PrEP  started prior to conception? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    otherarv_prior_source = models.CharField(
        verbose_name="Were Other ARVs started prior to conception?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    tdf_hivdeliv_source = models.CharField(
        verbose_name="Was TDF/FTC continued through delivery? (still on TDF/FTC when admitted for delivery)?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    taf_hivdeliv_source = models.CharField(
        verbose_name="Was TAF/FTC continued through delivery? (still on TAF/FTC when admitted for delivery)?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    tld_hivdeliv_source = models.CharField(
        verbose_name="Was TLD continued through delivery? (still on TLD when admitted for delivery)?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    cab_hivdeliv_source = models.CharField(
        verbose_name="Was Cabotegravir continued through delivery? (still on Cabotegravir when admitted for delivery)?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    unsp_hivdeliv_source = models.CharField(
        verbose_name="Was unspeciified PrEP continued through delivery? (still onUnspecified PrEP when admitted for delivery)?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    otherarv_hivdeliv_source = models.CharField(
        verbose_name="Were the Other ARVs continued through delivery? (still on Other ARVs when admitted for delivery)Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivttdf_source = models.CharField(
        verbose_name="What was the start date for TDF/FTC?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivttaf_source = models.CharField(
        verbose_name="What was the start date for TAF/FTC?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivttld_source = models.CharField(
        verbose_name="What was the start date for TLD?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    arv_hivneg_cabstart = models.DateField(
        verbose_name="What was the start date for cabotegravir?",
        blank=True,
        null=True,
        help_text="If unknown leave blank",
    )

    date_hivcab_source = models.CharField(
        verbose_name="What was the start date for Cabotegravir?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivunsp_source = models.CharField(
        verbose_name="What was the start date for Unspecified PrEP?Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivother_source = models.CharField(
        verbose_name="What was the start date for other ARVs? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivnegtdf_stopsource = models.CharField(
        verbose_name="What was the stop date for TDF/FTC? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivnegtaf_stopsource = models.CharField(
        verbose_name="What was the stop date for TAF/FTC? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivnegtld_stopsource = models.CharField(
        verbose_name="What was the stop date for TLD? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivcab_stopsource = models.CharField(
        verbose_name="What was the stop date for Cabotegravir? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivuns_stopsource = models.CharField(
        verbose_name="What was the stop date for unspecified PrEP? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    date_hivother_stopsource = models.CharField(
        verbose_name="What was the stop date for Other ARVs? Source of information used( choose ALL that apply)",
        max_length=1,
        choices=(("1", "Mother's report"), ("3", "OB card")),
        help_text="",
    )
    ...
    maternal_covidtransferhosp = models.CharField(
        ...
        choices=(
            ("1", "PMH"),
            ("2", "NRH"),
            ("3", "University of Botswana Academic hospital"),
            ("4", "Gabs Private"),
            ("5", "Bokamoso"),
            ("6", "Other Private hospital"),
            ("7", "South African hospital"),
            ("8", "Unknown"),
        ),
        help_text="",
    )
    ...
    eit = models.CharField(
        verbose_name="Was this infant screened for the Moso study?",
        max_length=1,
        choices=(("1", "Yes"), ("0", "No")),
        help_text="",
    )
    ...
    eit_bid = models.CharField(
        verbose_name="What is the Moso screening BID?",
        max_length=100,
        help_text='Should look like "S-40-0001-91"',
    )
    ...
    safebirth_red_dot = models.CharField(
        verbose_name="Did you find the Red dot on this file for Safe Birth Study ?",
        max_length=1,
        choices=(("1", "Yes"), ("0", "No")),
        help_text="Red Dot can be usual found on the front of the OB card",
    )
    ...
    ca_management = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Seen by an Medical Officer in the hospital"),
            ("2", "Seen by a Pediatrician in the hospital"),
            ("9", "Admitted to the NNU"),
            (
                "3",
                "Transferred directly to another hospital for further management",
            ),
            ("4", "Referred to a pediatrician or specialist after discharge"),
            ("5", "Told to follow up at the local clinic after discharge"),
            (
                "6",
                "Told there was no need for any follow up for this abnormality",
            ),
            ("7", "N/A because this was a stillbirth"),
            ("8", "N/A because this child died soon after birth"),
            ("99", "Unknown"),
            ("10", "Other"),
        ),
        help_text="",
    ...
    noattempt_consent_reason = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "Nurse did not alert RA about the abnormality"),
            ("2", "Delivery happened at night/after working hours"),
            ("3", "Delivery happened on a weekend"),
            (
                "4",
                "Delivery happened when RA was on leave, at a training or at a workshop",
            ),
            ("5", "Mother left the hospital before consent was attempted"),
            (
                "7",
    ...
    ca_notcall = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "Extra digit (soft, no bone, next to the 5th digit)"),
            ("2", "Umbilical Hernia"),
            ("3", "Birthmark"),
            ("4", "Hyperextended leg"),
            ("5", "Albino"),
    ...
    extra_digit_lhand = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "Near the 5th digit (little finger, pinky finger)"),
            ("2", "Near the thumb"),
            ("3", "Other place"),
        ),
        help_text="",
    ...
    extra_digit_rfoot = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "Near the 5th digit (little toe, pinky toe)"),
            ("2", "Near the big toe"),
            ("3", "Other place"),
        ),
        help_text="",
    ...
    skulldefect_desc = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Completely covered by skin"),
            ("2", "Partly covered by skin"),
            ("3", "Covered by a thin sac/membrane"),
            ("4", "Not covered by skin (brain tissue visible)"),
            ("99", "UNKNOWN"),
        ),
        help_text="",
    )
    ...
    spine_defectdesc = models.CharField(
        ...
        max_length=2,
        choices=(
            ("1", "Covered in hair and NOT bulging out"),
            ...
            ("6", "Open-can see the spine/spinal cord"),
            ("99", "UNKNOWN"),
        ),
        help_text="",
    )
    ...
    ca_list = models.CharField(
        ...
        choices=(
            ...
            ("3", "anencephaly"),
            ("54", "anencephaly with craniorachischisis"),
            ("37", "ankyloglossia"),
            ("55", "anopthalmia"),
            ("56", "arthrogryphosis"),
            ("57", "asymmetric face"),
            ("58", "benign cyst at urethral opening"),
            ("48", "bifid thumb"),
            ("170", "bifid toe"),
            ("5", "birth injury"),
            ("59", "birthmark"),
            ...
            ("60", "calcaneovalgus deformity, unilateral foot"),
            ("61", "caput"),
            ("62", "cardiac defect"),
            ("46", "cebocephaly"),
            ("63", "chest wall defect"),
            ("64", "chordae"),
            ("65", "chromosomal abnormality"),
            ("66", "cleft hand"),
            ("6", "cleft lip"),
            ("7", "cleft palate"),
            ("67", "congenital cataract"),
            ("68", "congential absence/reduction of tibia"),
            ("69", "connective tissue disorder"),
            ("70", "craniofacial anomolies"),
            ("8", "crypthopathmos"),
            ("71", "CT head findings of large cyst"),
            ("72", "cup ear deformity"),
            ("45", "cystic hygroma"),
            ("73", "decreased muscle tone (legs)"),
            ("9", "dental cyst"),
            ("75", "depressed nasal ridge"),
            ("76", "depression of scalp (potential birth injury)"),
            ("40", "disseminated hairy nevus"),
            ("10", "Downs syndrome"),
            ("77", "duplicate nipple"),
            ("78", "duplicated ear canal"),
            ("11", "dysmorphic facial features"),
            ("79", "ear deformity"),
            ("12", "encephalocele"),
            ("80", "enlarged labia"),
            ("81", "enlarged liver"),
            ("82", "epidermolysis bullosa (not CA)"),
            ("174", "eye swelling"),
            ("83", "facial abnormality"),
            ("171", "fetal alcohol syndrome"),
            ("84", "finger contractures (likely not abnormality)"),
            ("13", "foreskin defect"),
            ("85", "gangrenous forearm"),
            ("86", "gastroschesis"),
            ("87", "genetic syndrome"),
            (
                "88",
            ...
            ("16", "glanular hypospadius"),
            ("89", "growth on tongue"),
            ("90", "gynecomastia"),
            ("91", "hand deformity (unspecified)"),
            ("92", "hemangiomas"),
            ("93", "hematoma"),
            ...
            ("14", "hydrocephalus"),
            ("96", "hydronephrosis"),
            ("15", "hyperextended leg"),
            ("97", "hyperpigmentation"),
            ("98", "hypodactaly"),
            ("99", "hypopigmented patches"),
            ("100", "hypospadias, NOS"),
            ("18", "imperforate anus"),
            ("101", "increased space between first and second toe"),
            ("102", "inguinal hernia"),
            ("103", "iniencephaly"),
            ("19", "isolated bowed tibia"),
            ("104", "jaw assymetry"),
            ("105", "limb defect (skeletal defect vs. bilateral short femur)"),
            ("20", "limb-body wall defect"),
            ("106", "lipoma (fatty lump near spine)"),
            ("107", "low set ears"),
            (
                "108",
                "major foot deformity (terminal transverse defect with loss of forefoot)",
            ),
            ("109", "major limb defect"),
            ("110", "malformation of umbilial vein"),
            ("111", "malformation of upper extremities"),
            ("22", "meningocele/myelomeningocele"),
            ("112", "microcephaly"),
            ("113", "micrognathia"),
            ("114", "micropthalmia"),
            ("115", "microsomia"),
            ("116", "microtia"),
            ("117", "mid-face deformity"),
            ("118", "monodactyly (both arms)"),
            ("119", "moulding"),
            ("21", "multiple abnormalities of unknown etiology"),
            ("120", "multiple nevi (i.e. melanocytic nevi)"),
            ("23", "natal teeth/tooth"),
            ("121", "nevocellular nevus"),
            ("122", "nevus"),
            ("24", "omphalmocele"),
            ("123", "outer ear abnormality"),
            ("124", "overlapping toes"),
            ("125", "penile deformity (bent penis)"),
            ("17", "penile hypospadius"),
            ("42", "perineal hypospadius"),
            ("41", "phimosis"),
            ...
            (
                "135",
                "protruding left eye in macerated stillbirth or protruding eyes",
            ),
            ("136", "prune belly syndrome"),
            ("137", "right sided facial palsy (6th cranial nerve)"),
            (
                "138",
                "ruggae on skin of skull (underlying abnormality of skull/brain)",
            ),
            ("139", "sacrococcygeal teratoma"),
            ("140", "scalp defect"),
            ("141", "sebaceous nevus"),
            (
                "142",
            ...
            ("34", "skeletal dysplasia"),
            ("172", "skin tag"),
            ("143", "small growth near breast"),
            ("144", "small nose"),
            ("145", "small penis"),
            ("146", "spinal abnromalities"),
            ("147", "split foot/split hand deformity"),
            ("148", "swelling of right face and chest"),
            ("173", "swollen labia"),
            ("149", "syndactaly"),
            ("150", "syndactaly of toes"),
            ("151", "syndactly of toes with gigantism"),
            ("152", "talipes"),
            ("36", "talipes equinovarus bilateral"),
            ("35", "talipes equinovarus unilateral"),
            ("153", "tetrafocal melia"),
            ("154", "thumb hypoplasia"),
            ("155", "total absence of chest and abdominal wall"),
            ("156", "tragus deformity"),
            ("157", "triphalyngeal thumb"),
            ("158", "trisomy 13"),
            ("159", "trisomy 18"),
            ("160", "trisomy 21"),
            ("161", "twisted umbilical cord"),
            ("38", "umbilical hernia"),
            ("162", "underdevelopment of the lower face"),
            ("163", "undescended testicles"),
            ("164", "unilateral cleft lip"),
            ("0", "unknown"),
            ("165", "vaginal fistula"),
            ("166", "vaginal polyp"),
            ("44", "vaginal tag"),
            ("167", "vascular malformation"),
            ("168", "vascular malformation (severe)"),
            ("169", "wide fontanelle"),
            ("175", "Absence of Tibia"),
            ("176", "Brachial cleft cyst"),
            ("177", "Central digit hypoplasia"),
            ("178", "Chest asymmetry"),
            ("179", "Dextrocardia"),
            (
                "180",
                "Deformed/abnormal upper extremity (no further description)",
            ),
            ("181", "Deformed lower extremity (no further description)"),
            ("182", "Deformed head (no further description)"),
            (
                "205",
                "Deformed face/Facial abnormalities (no further description)",
            ),
            ("202", "Esophageal fistula"),
            ("203", "Epispadias"),
            ("183", "Excess hair"),
            ("184", "Fetal hydrops (hydrops fetalis)"),
            ("185", "Growth on cheek"),
            ("186", "Growth on tongue"),
            ("218", "growth on the leg"),
            ("211", "hepatomegaly"),
            ...
            ("216", "occipital cyst"),
            ("212", "palpable mass in abdomen"),
            ("188", "Pedicle at the edge of nostril"),
            ("206", "Peeling skin"),
            ("189", "Prominent rib"),
            ("190", "Rash"),
            ("191", "Renal cyst"),
            ("192", "Saddle scrotum"),
            ("215", "short lower limbs"),
            ("193", "Short neck"),
            ("210", "Skin lesion near armpit"),
            ("194", "Skin pedicle on anus"),
            ("195", "Skin tag on chin"),
            ("208", "Small growth on the anal orifice"),
            ("196", "Sores on the hard palate"),
            ("209", "Sore on the penis"),
            ("204", "Strabismus"),
            ("214", "Swollen foreskin"),
            ("197", "Swelling of neck"),
            ("198", "Terminal transverse limb defect with nubbins"),
            ("199", "Umbilical cord abnormality"),
            ("200", "Wide spaced nipples"),
            ("201", "Wrinkly skin"),
            (
                "254",
                "Absence of bladder seen on ultrasound (no visible abnormality)",
            ),
            ("219", "Absence of mandible"),
            ("220", "Amelia"),
            ("221", "adactylyia (nubbins)"),
            ("222", "Absent Ulna"),
            ("223", "Apert's syndrome"),
            ("224", "Brachydactyly"),
            ("225", "Chest wall mass"),
            ("252", "Cleft lip microform"),
            ("226", "Dilated bowel loops"),
            ("227", "elevated skin lesion of unknown etiology"),
            ("228", "Esophageal Atresia"),
            ("229", "Enlarged testicles"),
            ("230", "Finger gigantism unilateral"),
            ("231", "foreskin discoloration"),
            ("232", "Gigantism of arm"),
            ("233", "Gum cleft"),
            ("234", "Hyperextended arms"),
            ("253", "Hypoplastic toes"),
            ("235", "incomplete formation of skull bones"),
            ("236", "Large Tongue"),
            ("237", "Lipomyelomeningocele"),
            ("238", "Lower extremity edema"),
            ("239", "Mass on the side of head"),
            ("240", "Nasal polyp"),
            ("241", "Nose hypoplasia"),
            ("242", "Pectus excavatum"),
            ("243", "Polysyndactyly"),
            ("244", "Sacral dimple"),
            ("245", "scoliosis"),
            ("246", "short 3rd toe bilaterally"),
            ("247", "Sirenomelia"),
            ("248", "Spinal Dysraphism"),
            (
                "249",
                "Symbrachydactyly with overgrowth (giantism) of index finger",
            ),
            ("250", "Toe Gigantism"),
            ...
            (
                "257",
                "extra digit, no bone, with stalk in middle of unilateral foot",
            ),
            ("258", "finger hypoplasia"),
            ("259", "gigantism of the leg"),
            ("260", "hip dysplasia"),
            ("261", "lipoma of arm"),
            ("262", "major abnormality of the mouth"),
            ("263", "major foot abnormality"),
            ("273", "otocephaly"),
            ...
            ("267", "spin bifida occulta"),
            ("268", "spinal appendage"),
            ("269", "sublingual cyst"),
            ("270", "turned out toe"),
    ...
    ntd_twin = models.CharField(
        verbose_name="Is this a neural tube defect in the twin (second born)",
        max_length=1,
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
    ...
    ntd_triplet = models.CharField(
        verbose_name="Is this a neural tube defect in the triplet (third born)",
        max_length=1,
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
    ...
    ntd_quad = models.CharField(
        verbose_name="Is this a neural tube defect in the quadruplet (fourth born)",
        max_length=1,
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
    ...
    ca_majorabn = models.CharField(
        ...
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
            ("0", "No (photo available)"),
            ("3", "Unlikely (no photo available)"),
            ("99", "Unknown"),
            ("4", "Not an abnormality"),
        ),
        help_text="",
    )

    ca_majorabn_twin = models.CharField(
        verbose_name="Is this a major abnormality in the twin (second born)?",
        max_length=2,
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
    ...
    ca_majorabn_triplet = models.CharField(
        verbose_name="Is this a major abnormality in the triplet (third born)?",
        max_length=2,
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
    ...
    ca_majorabn_quad = models.CharField(
        verbose_name="Is this a major abnormality in the quadruplet (fourth born)?",
        max_length=2,
        choices=(
            ("1", "Yes (photo available)"),
            ("2", "Probable (no photo available)"),
    ...
    class Meta:
        app_label = 'tsepamo'
        verbose_name = 'Tsepamo 3'
        verbose_name_plural = 'Tsepamo 3'
