...
class TsepamoOne (RecordIDModelMixin,CompleteFieldMixin,models.Model):
    ...
    placental_fetalmalp = models.CharField(
    ...
    placental_pcdecid = models.CharField(
    ...
    verbose_name="Date first tested positive",
    blank=True, null=True,
    help_text="MM - DD - YY   If UNKNOWN, Leave BLANK", )
    ...
    max_length=1,
    choices=(('1', 'Yes'), ('2', 'No (documented that no counseling provided)'), ('3', 'Unknown (not documented)')),
    blank=True, null=True,
    help_text="", )
    ...
    max_length=1,
    choices=(('1', 'Breastfeeding (BF or EBF)'), ('2', 'Formula feeding (FF or EFF)'), ('3', 'Undecided'), ('4', 'Unknown (not recorded)')),
    blank=True, null=True,
    help_text="", )
    ...
    was_this_woman_on_aspirin = models.CharField(
    ...
    max_length=2,
    choices=(('1', 'Herpes (HSV)/Genital Ulcers/Genital Sores'), ('2', 'Varicella (chicken pox or zoster)'), ('3', 'Rubella'), ('4', 'Toxoplasmosis'), ('5', 'Syphilis (VDRL +, VDRL-reactive)'), ('6', 'Cervicitis/STD/Vaginal Discharge Syndrome (VDS) (sometimes listed as PVD, vaginitis or specific STD like gonorrhea (GC), chlamydia (CT), trichomoniasis (TV))'), ('7', 'High Blood Pressure (High BP, hypertension, elevated BP, Gestational Hypertension, PIH, Pregnancy Induced Hypertension)'), ('12', 'Pre-Ecclampsia or Ecclampsia'), ('9', 'Diabetes'), ('10', 'UTI/Pyelonephritis'), ('11', 'Anemia'), ('13', 'Malaria'), ('14', 'TB'), ('15', 'abscess'), ('16', 'asthma'), ('17', 'breast lump'), ('18', 'Candida/Candidiasis'), ('19', 'Cold/Common cold'), ('20', 'Cough'), ('21', 'diarrhoea, gastroenteritis'), ('22', 'epigastric pain'), ('23', 'fever'), ('24', 'ear infection'), ('25', 'eye infection'), ('26', 'fibroids'), ('27', 'warts/genital warts/vulvar warts/anal warts'), ('28', 'headache'), ('29', 'heartburn'), ('30', 'hyperemesis'), ('31', 'PID (pelvic inflammatory disease)'), ('32', 'Rash'), ('33', 'Respiratory tract infection/URTI (upper resp tract infection)'), ('34', 'sore throat/tonsillitis'), ('35', 'psychiatric/mental disorders'), ('36', 'Assault/Trauma'), ('37', 'Epilepsy/Seizures'), ('38', 'Scorpion stings/bites'), ('39', 'Parasites/Intestinal worms'), ('40', 'Fungal Infection'), ('41', 'Gastritis/Peptic Ulcer/Abdominal Ulcer'), ('42', 'Cancer'), ('43', 'DVT'), ('44', 'Bronchitis'), ('45', 'Pneumonia'), ('46', 'Epistaxis (bleeding from the nose)'), ('47', 'Hypotension'), ('48', 'Cyst'), ('49', 'Abdominal Pain'), ('50', 'Backache/Waist ache'), ('51', 'altered comfort/pain'), ('8', 'Other'), ('0', 'None'), ('99', 'Unknown')),
    blank=True, null=True,
    help_text="Check All that Apply", )
    ...
    max_length=2,
    choices=(('1', 'Ceftriaxone'), ('2', 'Erythromycin'), ('10', 'Azithromycin'), ('3', 'Metronidazole'), ('4', 'Amoxicillin'), ('5', 'Doxycycline'), ('6', 'Penicillin'), ('7', 'Cloxacillin'), ('8', 'Cotrimoxazole (CTX)'), ('9', 'Fluconazole'), ('14', 'Other')),
    blank=True, null=True,
    help_text="Check All that Apply", )
    ...
    max_length=1,
    choices=(('1', 'Definite'), ('2', 'Probable'), ('3', 'Possible'), ('4', 'Uncertain')),
    blank=True, null=True,
    help_text="", )
    ...
    max_length=1,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No'), ('3', 'Unknown')),
    blank=True, null=True,
    help_text="", )

    ntd_twin = models.CharField(
    verbose_name="Is this a neural tube defect in the TWIN (second birth in multiples",
    max_length=1,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No'), ('3', 'Unknown')),
    blank=True, null=True,
    help_text="", )
    ...
    verbose_name="Is this a neural tube defect in the TRIPLET (third birth in multiples",
    max_length=1,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No'), ('3', 'Unknown')),
    blank=True, null=True,
    help_text="", )
    ...
    verbose_name="Is this a neural tube defect in the QUADRUPLET (fourth birth in multiples)",
    max_length=1,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No'), ('3', 'Unknown')),
    blank=True, null=True,
    help_text="", )
    ...
    max_length=2,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No (photo available)'), ('3', 'Unlikely (no photo available)'), ('99', 'Unknown'), ('4', 'Not an abnormality')),
    blank=True, null=True,
    help_text="", )

    ca_majorabn_twin = models.CharField(
    verbose_name="Is this a major abnormality in the TWIN (second birth in multiples)?",
    max_length=2,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No (photo available)'), ('3', 'Unlikely (no photo available)'), ('99', 'Unknown'), ('4', 'Not an abnormality')),
    blank=True, null=True,
    help_text="", )
    ...
    verbose_name="Is this a major abnormality in the TRIPLET (thirdbirth in multiples)?",
    max_length=2,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No (photo available)'), ('3', 'Unlikely (no photo available)'), ('99', 'Unknown'), ('4', 'Not an abnormality')),
    blank=True, null=True,
    help_text="", )
    ...
    verbose_name="Is this a major abnormality in the QUADRUPLET (fourth birth in multiples)?",
    max_length=2,
    choices=(('1', 'Yes (photo available)'), ('2', 'Probable (no photo available)'), ('0', 'No (photo available)'), ('3', 'Unlikely (no photo available)'), ('99', 'Unknown'), ('4', 'Not an abnormality')),
    blank=True, null=True,
    help_text="", )
