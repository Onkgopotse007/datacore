...
class OutcomesOne(RecordIDModelMixin, models.Model):
  ...
  verbose_name="What type of care was the child receiving? (i.e. location (government or private), traditional medicine)STOP HERE ",
  blank=True, null=True,
  help_text="", )
