...
class SwitcherIPMSThree(RecordIDModelMixin, models.Model):
    ...
    recentrna_undetect_value = models.CharField(
        ...
        max_length=1,
        choices=(
            ("1", "< 400 or less than 400"),
            ("2", "< 50 or less than 50"),
            ("3", "< 25 or less than 25"),
            ("0", "0"),
            ("4", "Other"),
        ),
        blank=True,
    ...
    class Meta:
        app_label = 'tsepamo'
        verbose_name = 'Switcher IPMS 3'
        verbose_name_plural = 'Switcher IPMS 3'
